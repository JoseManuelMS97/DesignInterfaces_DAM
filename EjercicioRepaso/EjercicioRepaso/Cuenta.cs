...
namespace EjercicioRepaso
{
    class Cuenta
    {
        ...
        protected DateTime FechaNac { get; set; }
        ...
        public void esTitularValido(DateTime hoy, DateTime FechaNac)
        {
            int age = hoy.Year - FechaNac.Year;
            if (hoy < FechaNac.AddYears(age)) age--;
